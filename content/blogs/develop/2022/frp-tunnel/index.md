...
- 建立好帳號後，進入 [AWS console](https://console.aws.amazon.com/console/)，點擊 EC2。
  ![](images/chrome_lk5fqYZhYL.webp)
- 點擊啟動執行個體
  ![](images/chrome_H0uFz5vH3y.webp)
- 取名為 frp-tunnel
  ![](images/chrome_I3wkK7askV.webp)
- 選用自己習慣的 linux distro，這邊我習慣使用 ubuntu，故選 ubuntu 22.04。
  ![](images/chrome_z5KPS18q6J.webp)
- 執行個體類型選 t2.micro，金鑰由於安全因素，請建立新的金鑰對(key pair)
  ![](images/chrome_8Cfa1EOR9c.webp)
- 由於我使用 ubuntu 22.04，故使用 ED25519 來加密(RSA 已被淘汰)。下載下來的 pem or ppk 需要好好保存，未來不能再下載。
  ![](images/chrome_VzVIcfHUg0.webp)
- 網路設定的部分，ssh 的 source 使用`我的IP`，不要一開機就被陌生人打穿。
  ![](images/chrome_Qx4K4tK1jT.webp)
- 設定存儲的部分，若是使用 AWS Linux 的話可以預設 8GB 沒問題，我自己的 ubuntu vm 習慣 20GB，所以設成 20GB。
  ![](images/chrome_Pu7Weq1NXU.webp)
- 最後確認一下右邊的摘要，就可以點擊啟動執行個體。
  ![](images/chrome_dJxs8LK4lG.webp)
- 建立完成後就會轉跳至完成頁面。
  ![](images/chrome_TRIPSPPEva.webp)

## ssh 連線至 EC2

- 在 console 頁可以看到剛剛建立的 EC2 instance，點擊可以進入 instance 頁面。
  ![](images/chrome_JuQsMOCLAR.webp)
- 在頁面內點擊右上角的連線
  ![](images/chrome_FEs9DnrysN.webp)
- 在頁面內點擊右上角的連線
  ![](images/chrome_FEs9DnrysN.webp)
- AWS 會提示你如何連線進來。
  ![](images/chrome_pcw8mONuWx.webp)
