...
- 建立好帳號後，進入 [AWS console](https://console.aws.amazon.com/console/)，點擊 EC2。
    ![](images/chrome_lk5fqYZhYL.png)
- 點擊啟動執行個體
    ![](images/chrome_H0uFz5vH3y.png)
- 取名為 frp-tunnel
    ![](images/chrome_I3wkK7askV.png)
