...
4. 下載並安裝 [VcXsrv Windows X Server](https://sourceforge.net/projects/vcxsrv/)
   ![](images/vcxsrv-64.1.20.14.0.installer_QThVt5YaQ8.webp)
5. 在 Windows 中啟動 X server。
   1. 啟動 XLaunch
      ![](images/Code_v2XhXW1NOO.webp)
   2. 選擇 One large window，以及 Display Number: 0
      ![](images/xlaunch_1bMYdjPQ3Z.webp)
   3. 選擇 Start no client
      ![](images/xlaunch_SHlZcl2xiD.webp)
   4. 三個全勾，額外參數輸入 `-ac`
      ![](images/xlaunch_EN1I1BkqQS.webp)
   5. 接著點選完成會跳出一個全黑的畫面，這樣就完成 X server 啟動了。
      ![](images/xlaunch_iNe6bBRJdq.webp)
6. 回到 WSL 中輸入 `startxfce4` 啟動 xfce4 桌面
   ...
   sudo startxfce4
   ```
   ![](images/WindowsTerminal_TeEkKP3j4Z.webp)
   ![](images/vcxsrv_QQ4TbA3bjf.webp)
