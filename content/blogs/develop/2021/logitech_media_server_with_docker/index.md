...
1. 首先我把我的音樂都存放在 NAS 上，先將 music 資料夾給共享出來
   ![](images/chrome_eeCPLxdAc7.webp)
2. 接著到 portainer 中建立三個 volume
   a. lms-music
   輸入在 NAS 分享出來的目錄與使用者、密碼，建立一個 cifs mounted volume
   ![](images/chrome_ldBeP6Fxh9.webp)
   b. lms-config
   ![](images/chrome_OWW2NmHnVl.webp)
   c. lms-playlist
   ![](images/chrome_yfoLywNeFT.webp)
...
![](images/SqueezeliteX_xjgIPyJ4B9.webp)
